	...
	echo '<nav class="navbar navbar-default" role="navigation">';
			...
			echo '<li class="panel panel-default" id="dropdown">';
				echo '<a data-toggle="collapse" href="#dropdown-lvl1">';
					echo '<span class="glyphicon glyphicon-th-list"></span> Categorias <span class="caret"></span>';
				echo '</a>';
				echo '<!-- Dropdown level 1 -->';
				echo '<div id="dropdown-lvl1" class="panel-collapse collapse">';
					echo '<div class="panel-body">';
						echo '<ul class="nav navbar-nav">';
							echo '<li><a href="#">Electronica</a></li>';
							echo '<li><a href="#">Deportes</a></li>';
							echo '<li><a href="#">Coches y motos</a></li>';
							echo '<li><a href="#">Juegos y consolas</a></li>';
							echo '<li><a href="#">Libros peliculas y musica</a></li>';
